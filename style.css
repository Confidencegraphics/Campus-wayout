...
@media (max-width:880px){
  #mobileToggle{
    ...
    border:1px solid rgba(243,235,218,0.2);
    color:var(--cream);
    border-radius:10px;
    padding:9px 12px;
  ...
  #list{ display:none; }
  #sidebar.expanded #list{ display:block; }
  #mapWrap{ padding:6px 14px 14px; }
  #mapToolbar{ padding:14px 14px 4px; }
  #detailPanel{ right:14px; left:14px; width:auto; bottom:14px; }
  #hudStack{ left:10px; right:10px; top:10px; }
}